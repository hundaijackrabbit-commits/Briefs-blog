...
export async function GET(req:NextRequest){
  ...
  return NextResponse.json({version:"1.0.0",readiness:productionReadiness(),operations:await operationalSnapshot(),time:new Date().toISOString()},{headers:{"cache-control":"no-store"}});
}
